      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleLogin">
        ...
        <div>
          <button 
            type="submit" 
            :disabled="loading"
            class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black disabled:opacity-50 transition-colors"
          >
        ...
        <div class="text-center text-sm">
          <p class="text-gray-600">
            Não tem uma conta? 
            <RouterLink to="/cadastro" class="font-medium text-blue-600 hover:text-blue-500">
              Cadastre-se aqui
            </RouterLink>
          </p>
        </div>
