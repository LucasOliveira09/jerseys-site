      ...
      <div class="bg-[#151515] border-y border-white/5 py-8 md:py-10">
         <div class="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-y-8 gap-x-4">
            <div class="flex flex-col md:flex-row items-center md:items-start gap-3 text-center md:text-left group">
               <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-atk-neon/10 flex items-center justify-center text-xl md:text-2xl group-hover:bg-atk-neon group-hover:text-atk-dark transition-colors duration-300">
                 🔒
               </div>
               <div>
                  <h4 class="font-bold text-white text-xs md:text-sm uppercase tracking-wider mb-1">Compra Segura</h4>
                  <p class="text-[10px] md:text-xs text-gray-500">Dados 100% criptografados</p>
               </div>
            </div>
            <div class="flex flex-col md:flex-row items-center md:items-start gap-3 text-center md:text-left group">
               <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-atk-neon/10 flex items-center justify-center text-xl md:text-2xl group-hover:bg-atk-neon group-hover:text-atk-dark transition-colors duration-300">
               ...
               <div>
                  <h4 class="font-bold text-white text-xs md:text-sm uppercase tracking-wider mb-1">Envio Rastreado</h4>
                  <p class="text-[10px] md:text-xs text-gray-500">Acompanhe seu pedido</p>
               </div>
            </div>
            <div class="flex flex-col md:flex-row items-center md:items-start gap-3 text-center md:text-left group">
               <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-atk-neon/10 flex items-center justify-center text-xl md:text-2xl group-hover:bg-atk-neon group-hover:text-atk-dark transition-colors duration-300">
               ...
               <div>
                  <h4 class="font-bold text-white text-xs md:text-sm uppercase tracking-wider mb-1">Até 6x no Cartão</h4>
                  <p class="text-[10px] md:text-xs text-gray-500">Ou 2% OFF no PIX</p>
               </div>
            </div>
            <div class="flex flex-col md:flex-row items-center md:items-start gap-3 text-center md:text-left group">
               <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-atk-neon/10 flex items-center justify-center text-xl md:text-2xl group-hover:bg-atk-neon group-hover:text-atk-dark transition-colors duration-300">
               ...
               <div>
                  <h4 class="font-bold text-white text-xs md:text-sm uppercase tracking-wider mb-1">Garantia Total</h4>
                  <p class="text-[10px] md:text-xs text-gray-500">Troca caso tenha defeitos</p>
               </div>
            </div>
         </div>
      </div>
      ...
      <section class="my-8 md:my-16 relative h-auto md:h-[450px] flex items-center overflow-hidden border-y border-white/5 py-16 md:py-0">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 items-center w-full text-center md:text-left">
          <div>
            ...
            <h2 class="text-3xl md:text-6xl font-extrabold uppercase italic leading-none mb-6">
              Seu Nome.<br>Seu Número.
            </h2>
            <p class="text-gray-400 mb-8 max-w-md mx-auto md:mx-0 text-sm md:text-base leading-relaxed">
      ...
      <div class="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
         <div v-if="brasileirao.length > 0" class="bg-[#151515] rounded-2xl border border-white/5 p-5 md:p-8 flex flex-col shadow-lg">
            <div class="flex justify-between items-center mb-6 border-b border-white/10 pb-4">
               <h3 class="text-xl md:text-2xl font-bold uppercase italic text-yellow-400 flex items-center gap-2">
                 <span class="text-2xl">🇧🇷</span> Brasileirão
               </h3>
            ...
            <div class="grid grid-cols-2 gap-3 md:gap-4 flex-grow">
               <RouterLink :to="`/produto/${item.slug}`" v-for="item in brasileirao" :key="item.id" class="group block relative overflow-hidden rounded-lg bg-black/40 border border-white/5 hover:border-white/20 transition-all">
                  <div class="p-4 flex items-center justify-center aspect-[4/5]">
                     <img :src="item.image_cover" class="w-full h-full object-contain group-hover:scale-110 transition-transform duration-500 drop-shadow-xl">
                  </div>
         ...
         <div v-if="selecoes.length > 0" class="bg-[#151515] rounded-2xl border border-white/5 p-5 md:p-8 flex flex-col shadow-lg">
            <div class="flex justify-between items-center mb-6 border-b border-white/10 pb-4">
               <h3 class="text-xl md:text-2xl font-bold uppercase italic text-blue-400 flex items-center gap-2">
                 <span class="text-2xl">🌍</span> Seleções
               </h3>
               <RouterLink to="/produtos" class="text-[10px] md:text-xs text-gray-500 hover:text-white uppercase font-bold tracking-wider border border-white/10 px-3 py-1 rounded-full hover:bg-white/5 transition">Ver todos</RouterLink>
            </div>
            <div class="grid grid-cols-2 gap-3 md:gap-4 flex-grow">
...
.animate-marquee {
  ...
  min-width: 100%; /* Garante que o bloco ocupe todo o espaço */
  display: flex;
  justify-content: space-around; /* Distribui bem os itens */
}
